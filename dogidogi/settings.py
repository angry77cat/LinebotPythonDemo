"""
Django settings for dogidogi project.
...
SECRET_KEY = 'g*&ir^v4s35g1p(9)us@$%=59^my3f8axahc4%m5b0hp8a9den'
...
WSGI_APPLICATION = 'dogidogi.wsgi.application'
